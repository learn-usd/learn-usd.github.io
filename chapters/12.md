...
To create a wavy plane, we’ll build on the flat grid example from [Chapter 4](./4.md). Previously, we created a simple 2D plane with four points. Now, we’ll enhance that by adding more points and a height function to turn the flat surface into a 3D wavy mesh.
